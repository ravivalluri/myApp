$(document).ready(function () {
  ...
  var modalText = {
    msi: {
      ...
      detail: 'Built admin panel, user registration, email confirmation and shop UIs (Angular) and developed multiple APIs which retrieve the data on the UI, sync and feed the data to multiple applications. Automated the deployment of the application in multiple EC2 instances using Jenkins pipelines and replaced the manual Redis servers in the application with Elastic Cache and also connected the EC2 instances with ELB servers.',
      link: 'https://shop.motorolasolutions.com/home'
    },
    beam: {
      title: 'Beam Suntory',
      tag: 'Full Stack Developer',
      detail: 'Created modular components with Webpack, JSX and CSS Modules. Worked closely with the design and UX team to build out HTML emails, landing pages, and full-fledged responsive websites. Developed prototypes for new CRM software using Zurbs Foundation, SASS, and Backbone.js. Created and implemented a custom CSS grid system, with CSS media queries for mobile responsiveness.',
